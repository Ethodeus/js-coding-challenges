 // Get your shorts on - this is an array workout!
    ...
    const people = [
      ...
      //* 1. Filter the list of inventors for those who were born in the 1500's
        ...
        const yearFifteen = inventors.filter /** the filter loops through the whole arrow */ ((inventors) => { 
            if (inventors.year >= 1500 && inventors.year < 1600 ) { //the inventors function creates a condition to return values
                return true
            } 
        } )
    ...
    const inventorAge = inventors.sort((inventor1, inventor2) =>{
        ...
        if (age1 < age2) { // we are comparing both ages and setting a condition to sort them from actually youngest to oldest
            return -1
        } else {
            return 1
        } 
