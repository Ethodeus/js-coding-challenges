...
//TODO INSTRUCTIONS -> "Point reflection" or "point symmetry" is a basic concept in geometry where a given point, P, at a given position relative to a mid-point, Q has a corresponding point, P1, which is the same distance from Q but in the opposite direction.
...
function symmetricPoint(p, q) {
	const xCordinate = 2 * q[0] - p[0];
	const yCordinate = 2 * q[1] - p[1];
