...
//alternative with arrow function and if statement.

let shark = (pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) => {
	if (dolphin) {
		...
		if (pontoonDistance / youSpeed >= sharkDistance / (sharkSpeed / 1)) {
			return 'Shark Bait!';
		} else {
			return 'Alive!';
		}
