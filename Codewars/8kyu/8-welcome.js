...
//When we are trying to access the value with a string passed as a parameter, we can't use dot notation, in this case we would use the square bracket notation.
